...
export default function Home() {
  ...
  const handleTournamentRegister = async (_tournamentId: string) => {
    if (!user) return
        ...
        <div className="px-4 sm:px-0">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-gray-900 rounded-lg p-6 border border-gray-700 text-center">
              ...
              <p className="text-gray-300">Experience Population One&apos;srevolutionary Vertical Combat System in competitive tournaments.</p>
            </div>
          </div>
